/* HashTable Object Implementation
	Purpose:	Since JS has no inherent hashtable or dictionary you end up implementing them over and over
				so here we have a hashtable already implemented as I would have expected it to be in C#
	Examples:	ADD LATER
*/
